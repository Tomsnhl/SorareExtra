 ...
 */
class getGameweekRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GameweekRepository' shared autowired service.
     *
     * @return \App\Repository\GameweekRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GameweekRepository.php';

        return $container->privates['App\\Repository\\GameweekRepository'] = new \App\Repository\GameweekRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
